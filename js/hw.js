...
//     let priceStufings = Hamburger.STUFFINGS[this._stuffing].price;
//     let priceTopings = this._toppings.reduce((acc, el) => Hamburger.TOPPINGS[el].price + acc ,0);
//     // console.log(priceTopings);
//     return  priceSize + priceStufings + priceTopings;
//   }
...
//     let calTop = this._toppings.reduce((acc, el) => Hamburger.TOPPINGS[el].calories + acc, 0);
//     return calTop + calSize + calStuf;
//   }
// }
...
// Hamburger.SIZE_LARGE = 'SIZE_LARG';
...
// console.log(' getStuffing :', hamburger.getStuffing());
// /*
